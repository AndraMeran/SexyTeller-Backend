...
export async function register(req, res) {
    try {
        ...
        return res.status(201).json({
            ...
            token: generateToken(user._id, user.isRedazione, user.name, user.handle, user.avatar, user.cover),
...
export async function googleCallback(req, res) {
    try {
        ...
        const token = generateToken(user._id, user.isRedazione, user.name, user.handle, user.avatar, user.cover)
